    ...
    <v-ons-page>
        ...
        <ons-list>
            <v-ons-list modifier="inset">
                ...
                <v-ons-list-item>
                    <span class="bold left">Kopfgeld: </span> <span
                    class="right"
                    v-text="formatPrice(contractBounty)"
                ></span>
                </v-ons-list-item>
                <v-ons-list-item>
                    <span class="bold">Details: </span><br /> {{ contractDetails }}
                </v-ons-list-item>
            </v-ons-list>
            <v-ons-fab
                modifier="mini"
